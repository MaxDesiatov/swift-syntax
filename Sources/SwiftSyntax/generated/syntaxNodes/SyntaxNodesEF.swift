...
// MARK: - EffectsClauseSyntax

/// ### Children
/// 
///  - `effectsSpecifier`: `effects`
///  - `leftParen`: `(`
///  - `types`: ``EffectsTypeListSyntax``
///  - `rightParen`: `)`
///
/// ### Contained in
/// 
///  - ``AccessorEffectSpecifiersSyntax``.``AccessorEffectSpecifiersSyntax/effectsClause``
///  - ``DoHandleStmtSyntax``.``DoHandleStmtSyntax/effectsClause``
///  - ``FunctionEffectSpecifiersSyntax``.``FunctionEffectSpecifiersSyntax/effectsClause``
///  - ``TypeEffectSpecifiersSyntax``.``TypeEffectSpecifiersSyntax/effectsClause``
public struct EffectsClauseSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  public let _syntaxNode: Syntax

  public init?(_ node: __shared some SyntaxProtocol) {
    guard node.raw.kind == .effectsClause else {
      return nil
    }
    self._syntaxNode = node._syntaxNode
  }
  ...
  /// - Parameters:
  ///   - leadingTrivia: Trivia to be prepended to the leading trivia of the node’s first token. If the node is empty, there is no token to attach the trivia to and the parameter is ignored.
  ///   - effectsSpecifier: The `effects` keyword.
  ///   - leftParen: The '(' to open the effect type list.
  ///   - types: The list of effect types.
  ///   - rightParen: The ')' to close the effect type list.
  ///   - trailingTrivia: Trivia to be appended to the trailing trivia of the node’s last token. If the node is empty, there is no token to attach the trivia to and the parameter is ignored.
  public init(
    leadingTrivia: Trivia? = nil,
    _ unexpectedBeforeEffectsSpecifier: UnexpectedNodesSyntax? = nil,
    effectsSpecifier: TokenSyntax = .keyword(.effects),
    _ unexpectedBetweenEffectsSpecifierAndLeftParen: UnexpectedNodesSyntax? = nil,
    leftParen: TokenSyntax = .leftParenToken(),
    _ unexpectedBetweenLeftParenAndTypes: UnexpectedNodesSyntax? = nil,
    types: EffectsTypeListSyntax,
    _ unexpectedBetweenTypesAndRightParen: UnexpectedNodesSyntax? = nil,
    ...
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((RawSyntaxArena(), (
      unexpectedBeforeEffectsSpecifier,
      effectsSpecifier,
      unexpectedBetweenEffectsSpecifierAndLeftParen,
      leftParen,
      unexpectedBetweenLeftParenAndTypes,
      types,
      unexpectedBetweenTypesAndRightParen,
      rightParen,
      unexpectedAfterRightParen
    ))) { (arena, _) in
      let layout: [RawSyntax?] = [
        unexpectedBeforeEffectsSpecifier?.raw,
        effectsSpecifier.raw,
        unexpectedBetweenEffectsSpecifierAndLeftParen?.raw,
        leftParen.raw,
        unexpectedBetweenLeftParenAndTypes?.raw,
        types.raw,
        unexpectedBetweenTypesAndRightParen?.raw,
        rightParen.raw,
        unexpectedAfterRightParen?.raw
      ]
      let raw = RawSyntax.makeLayout(
        kind: SyntaxKind.effectsClause,
        from: layout,
        arena: arena,
        leadingTrivia: leadingTrivia,
        trailingTrivia: trailingTrivia
  ...
  public var unexpectedBeforeEffectsSpecifier: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 0)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 0, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(EffectsClauseSyntax.self)
    }
  }
  ...
  /// ### Tokens
  /// 
  /// For syntax trees generated by the parser, this is guaranteed to be `effects`.
  public var effectsSpecifier: TokenSyntax {
    get {
      return Syntax(self).child(at: 1)!.cast(TokenSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 1, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(EffectsClauseSyntax.self)
    }
  }

  public var unexpectedBetweenEffectsSpecifierAndLeftParen: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 2)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 2, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(EffectsClauseSyntax.self)
    }
  }

  /// The '(' to open the effect type list.
  ///
  /// ### Tokens
  /// 
  ...
  public var leftParen: TokenSyntax {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 3, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(EffectsClauseSyntax.self)
    }
  }

  public var unexpectedBetweenLeftParenAndTypes: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 4)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 4, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(EffectsClauseSyntax.self)
    }
  }

  /// The list of effect types.
  public var types: EffectsTypeListSyntax {
    get {
      return Syntax(self).child(at: 5)!.cast(EffectsTypeListSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 5, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(EffectsClauseSyntax.self)
    }
  }

  /// Adds the provided `element` to the node's `types`
  /// collection.
  ///
  /// - param element: The new `EffectsType` to add to the node's
  ///                  `types` collection.
  /// - returns: A copy of the receiver with the provided `EffectsType`
  ///            appended to its `types` collection.
  @available(*, deprecated, message: "Use node.types.append(newElement) instead")
  public func addEffectsType(_ element: EffectsTypeListElementSyntax) -> EffectsClauseSyntax {
    var collection: RawSyntax
    let arena = RawSyntaxArena()
    if let col = raw.layoutView!.children[5] {
      collection = col.layoutView!.appending(element.raw, arena: arena)
    } else {
      collection = RawSyntax.makeLayout(kind: SyntaxKind.effectsTypeList,
                                        from: [element.raw], arena: arena)
    }
    return Syntax(self)
      .replacingChild(
      ...
      .cast(EffectsClauseSyntax.self)
  }

  public var unexpectedBetweenTypesAndRightParen: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 6)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 6, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(EffectsClauseSyntax.self)
    }
  }

  /// The ')' to close the effect type list.
  ///
  /// ### Tokens
  /// 
  /// For syntax trees generated by the parser, this is guaranteed to be `)`.
  public var rightParen: TokenSyntax {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 7, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(EffectsClauseSyntax.self)
    }
  }
  ...
  public var unexpectedAfterRightParen: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 8, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(EffectsClauseSyntax.self)
    }
  }

  public static let structure: SyntaxNodeStructure = .layout([
    \Self.unexpectedBeforeEffectsSpecifier,
    \Self.effectsSpecifier,
    \Self.unexpectedBetweenEffectsSpecifierAndLeftParen,
    \Self.leftParen,
    \Self.unexpectedBetweenLeftParenAndTypes,
    \Self.types,
    \Self.unexpectedBetweenTypesAndRightParen,
    \Self.rightParen,
    \Self.unexpectedAfterRightParen
  ])
}

// MARK: - EffectsTypeListElementSyntax
...
/// ### Contained in
/// 
///  - ``EffectsTypeListSyntax``
public struct EffectsTypeListElementSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  public let _syntaxNode: Syntax

  public init?(_ node: __shared some SyntaxProtocol) {
    guard node.raw.kind == .effectsTypeListElement else {
      return nil
    }
    self._syntaxNode = node._syntaxNode
  }
  ...
  ///   - trailingComma: A trailing comma if there are more effect types.
  ///   - trailingTrivia: Trivia to be appended to the trailing trivia of the node’s last token. If the node is empty, there is no token to attach the trivia to and the parameter is ignored.
  public init(
    leadingTrivia: Trivia? = nil,
    ...
    self = withExtendedLifetime((RawSyntaxArena(), (
      ...
      let raw = RawSyntax.makeLayout(
        kind: SyntaxKind.effectsTypeListElement,
        from: layout,
        arena: arena,
        leadingTrivia: leadingTrivia,
        trailingTrivia: trailingTrivia
  ...
  public var unexpectedBeforeType: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 0, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(EffectsTypeListElementSyntax.self)
    }
  }
  ...
  public var type: TypeSyntax {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 1, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(EffectsTypeListElementSyntax.self)
    }
  }
  ...
  public var unexpectedBetweenTypeAndTrailingComma: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 2, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(EffectsTypeListElementSyntax.self)
    }
  }

  /// A trailing comma if there are more effect types.
  ///
  /// ### Tokens
  /// 
  /// For syntax trees generated by the parser, this is guaranteed to be `,`.
  public var trailingComma: TokenSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 3, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(EffectsTypeListElementSyntax.self)
    }
  }
  ...
  public var unexpectedAfterTrailingComma: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 4, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(EffectsTypeListElementSyntax.self)
    }
  }
...
/// ### Children
/// 
///  - `effectsClause`: ``EffectsClauseSyntax``?
...
public struct FunctionEffectSpecifiersSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  /// - Parameters:
  ///   - leadingTrivia: Trivia to be prepended to the leading trivia of the node’s first token. If the node is empty, there is no token to attach the trivia to and the parameter is ignored.
  ///   - effectsClause: The clause specifying declared context effects.
  ///   - asyncSpecifier: The `async` or `reasync` keyword.
  ///   - throwsClause: The clause specifying thrown errors
  ///   - trailingTrivia: Trivia to be appended to the trailing trivia of the node’s last token. If the node is empty, there is no token to attach the trivia to and the parameter is ignored.
  public init(
    leadingTrivia: Trivia? = nil,
    _ unexpectedBeforeEffectsClause: UnexpectedNodesSyntax? = nil,
    effectsClause: EffectsClauseSyntax? = nil,
    _ unexpectedBetweenEffectsClauseAndAsyncSpecifier: UnexpectedNodesSyntax? = nil,
    ...
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((RawSyntaxArena(), (
      unexpectedBeforeEffectsClause,
      effectsClause,
      unexpectedBetweenEffectsClauseAndAsyncSpecifier,
      asyncSpecifier,
      ...
      let layout: [RawSyntax?] = [
        unexpectedBeforeEffectsClause?.raw,
        effectsClause?.raw,
        unexpectedBetweenEffectsClauseAndAsyncSpecifier?.raw,
        asyncSpecifier?.raw,
  ...
  public var unexpectedBeforeEffectsClause: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 0)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
  ...
  /// The clause specifying declared context effects.
  public var effectsClause: EffectsClauseSyntax? {
    get {
      return Syntax(self).child(at: 1)?.cast(EffectsClauseSyntax.self)
    }
    set(value) {
  ...
  public var unexpectedBetweenEffectsClauseAndAsyncSpecifier: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 2)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
  ...
  public var throwsClause: ThrowsClauseSyntax? {
    get {
      return Syntax(self).child(at: 5)?.cast(ThrowsClauseSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 5, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(FunctionEffectSpecifiersSyntax.self)
    }
  }
  ...
  public var unexpectedAfterThrowsClause: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 6, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(FunctionEffectSpecifiersSyntax.self)
    }
  }
