...
public struct DoHandleStmtSyntax: StmtSyntaxProtocol, SyntaxHashable, _LeafStmtSyntaxNodeProtocol {
  public let _syntaxNode: Syntax

  public init?(_ node: __shared some SyntaxProtocol) {
    guard node.raw.kind == .doHandleStmt else {
      return nil
    }
    self._syntaxNode = node._syntaxNode
  }
  ...
  /// - Parameters:
  ///   - leadingTrivia: Trivia to be prepended to the leading trivia of the node’s first token. If the node is empty, there is no token to attach the trivia to and the parameter is ignored.
  ///   - effectsClause: Optional clause declaring which effects the body uses.
  ///   - handleKeyword: The `handle` keyword.
  ///   - trailingTrivia: Trivia to be appended to the trailing trivia of the node’s last token. If the node is empty, there is no token to attach the trivia to and the parameter is ignored.
  public init(
    leadingTrivia: Trivia? = nil,
    _ unexpectedBeforeDoKeyword: UnexpectedNodesSyntax? = nil,
    doKeyword: TokenSyntax = .keyword(.do),
    _ unexpectedBetweenDoKeywordAndEffectsClause: UnexpectedNodesSyntax? = nil,
    effectsClause: EffectsClauseSyntax? = nil,
    _ unexpectedBetweenEffectsClauseAndBody: UnexpectedNodesSyntax? = nil,
    body: CodeBlockSyntax,
    _ unexpectedBetweenBodyAndHandleKeyword: UnexpectedNodesSyntax? = nil,
    handleKeyword: TokenSyntax = .keyword(.handle),
    _ unexpectedBetweenHandleKeywordAndHandleClauses: UnexpectedNodesSyntax? = nil,
    handleClauses: HandleClauseListSyntax,
    _ unexpectedAfterHandleClauses: UnexpectedNodesSyntax? = nil,
    trailingTrivia: Trivia? = nil
  ) {
    // Extend the lifetime of all parameters so their arenas don't get destroyed
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((RawSyntaxArena(), (
      ...
      let layout: [RawSyntax?] = [
        unexpectedBeforeDoKeyword?.raw,
        doKeyword.raw,
        unexpectedBetweenDoKeywordAndEffectsClause?.raw,
        effectsClause?.raw,
        unexpectedBetweenEffectsClauseAndBody?.raw,
        body.raw,
        unexpectedBetweenBodyAndHandleKeyword?.raw,
        handleKeyword.raw,
        unexpectedBetweenHandleKeywordAndHandleClauses?.raw,
        handleClauses.raw,
        unexpectedAfterHandleClauses?.raw
      ]
      let raw = RawSyntax.makeLayout(
        kind: SyntaxKind.doHandleStmt,
        from: layout,
        arena: arena,
        leadingTrivia: leadingTrivia,
        trailingTrivia: trailingTrivia
  ...
  public var unexpectedBeforeDoKeyword: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 0, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(DoHandleStmtSyntax.self)
    }
  }
  ...
  public var doKeyword: TokenSyntax {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 1, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(DoHandleStmtSyntax.self)
    }
  }

  public var unexpectedBetweenDoKeywordAndEffectsClause: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 2)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 2, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(DoHandleStmtSyntax.self)
    }
  }

  /// Optional clause declaring which effects the body uses.
  public var effectsClause: EffectsClauseSyntax? {
    get {
      return Syntax(self).child(at: 3)?.cast(EffectsClauseSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 3, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(DoHandleStmtSyntax.self)
    }
  }

  public var unexpectedBetweenEffectsClauseAndBody: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 4)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 4, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(DoHandleStmtSyntax.self)
    }
  }
  ...
  public var body: CodeBlockSyntax {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 5, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(DoHandleStmtSyntax.self)
    }
  }

  public var unexpectedBetweenBodyAndHandleKeyword: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 6)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 6, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(DoHandleStmtSyntax.self)
    }
  }
  ...
  /// ### Tokens
  /// 
  /// For syntax trees generated by the parser, this is guaranteed to be `handle`.
  public var handleKeyword: TokenSyntax {
    get {
      return Syntax(self).child(at: 7)!.cast(TokenSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 7, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(DoHandleStmtSyntax.self)
    }
  }

  public var unexpectedBetweenHandleKeywordAndHandleClauses: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 8)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 8, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(DoHandleStmtSyntax.self)
    }
  }

  public var handleClauses: HandleClauseListSyntax {
    get {
      return Syntax(self).child(at: 9)!.cast(HandleClauseListSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 9, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(DoHandleStmtSyntax.self)
    }
  }

  /// Adds the provided `element` to the node's `handleClauses`
  /// collection.
  ///
  /// - param element: The new `HandleClause` to add to the node's
  ///                  `handleClauses` collection.
  /// - returns: A copy of the receiver with the provided `HandleClause`
  ///            appended to its `handleClauses` collection.
  @available(*, deprecated, message: "Use node.handleClauses.append(newElement) instead")
  public func addHandleClause(_ element: HandleClauseSyntax) -> DoHandleStmtSyntax {
    var collection: RawSyntax
    let arena = RawSyntaxArena()
    if let col = raw.layoutView!.children[9] {
      collection = col.layoutView!.appending(element.raw, arena: arena)
    } else {
      collection = RawSyntax.makeLayout(kind: SyntaxKind.handleClauseList,
                                        from: [element.raw], arena: arena)
    }
    return Syntax(self)
      .replacingChild(
      ...
      .cast(DoHandleStmtSyntax.self)
  }

  public var unexpectedAfterHandleClauses: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 10)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 10, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(DoHandleStmtSyntax.self)
    }
  }
  ...
  public static let structure: SyntaxNodeStructure = .layout([
    \Self.unexpectedBeforeDoKeyword,
    \Self.doKeyword,
    \Self.unexpectedBetweenDoKeywordAndEffectsClause,
    \Self.effectsClause,
    \Self.unexpectedBetweenEffectsClauseAndBody,
    \Self.body,
    \Self.unexpectedBetweenBodyAndHandleKeyword,
    \Self.handleKeyword,
    \Self.unexpectedBetweenHandleKeywordAndHandleClauses,
    \Self.handleClauses,
    \Self.unexpectedAfterHandleClauses
  ])
}
