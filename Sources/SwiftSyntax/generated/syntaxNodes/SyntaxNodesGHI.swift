...
///  - `handler`: ``ExprSyntax``
///  - `asKeyword`: `as`
///  - `effectType`: ``TypeSyntax``
///  - `trailingComma`: `,`?
///
/// ### Contained in
/// 
///  - ``HandleClauseListSyntax``
public struct HandleClauseSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  public let _syntaxNode: Syntax

  public init?(_ node: __shared some SyntaxProtocol) {
    guard node.raw.kind == .handleClause else {
      return nil
    }
    self._syntaxNode = node._syntaxNode
  }
  ...
  /// - Parameters:
  ///   - leadingTrivia: Trivia to be prepended to the leading trivia of the node’s first token. If the node is empty, there is no token to attach the trivia to and the parameter is ignored.
  ///   - handler: The handler expression.
  ///   - asKeyword: The `as` keyword.
  ///   - effectType: The effect protocol type.
  ///   - trailingComma: A trailing comma if there are more handle clauses.
  ///   - trailingTrivia: Trivia to be appended to the trailing trivia of the node’s last token. If the node is empty, there is no token to attach the trivia to and the parameter is ignored.
  public init(
    leadingTrivia: Trivia? = nil,
    _ unexpectedBeforeHandler: UnexpectedNodesSyntax? = nil,
    handler: some ExprSyntaxProtocol,
    _ unexpectedBetweenHandlerAndAsKeyword: UnexpectedNodesSyntax? = nil,
    asKeyword: TokenSyntax = .keyword(.as),
    _ unexpectedBetweenAsKeywordAndEffectType: UnexpectedNodesSyntax? = nil,
    effectType: some TypeSyntaxProtocol,
    _ unexpectedBetweenEffectTypeAndTrailingComma: UnexpectedNodesSyntax? = nil,
    trailingComma: TokenSyntax? = nil,
    _ unexpectedAfterTrailingComma: UnexpectedNodesSyntax? = nil,
    trailingTrivia: Trivia? = nil
  ) {
    ...
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((RawSyntaxArena(), (
      unexpectedBeforeHandler,
      handler,
      unexpectedBetweenHandlerAndAsKeyword,
      asKeyword,
      unexpectedBetweenAsKeywordAndEffectType,
      effectType,
      unexpectedBetweenEffectTypeAndTrailingComma,
      trailingComma,
      unexpectedAfterTrailingComma
    ))) { (arena, _) in
      let layout: [RawSyntax?] = [
        unexpectedBeforeHandler?.raw,
        handler.raw,
        unexpectedBetweenHandlerAndAsKeyword?.raw,
        asKeyword.raw,
        unexpectedBetweenAsKeywordAndEffectType?.raw,
        effectType.raw,
        unexpectedBetweenEffectTypeAndTrailingComma?.raw,
        trailingComma?.raw,
        unexpectedAfterTrailingComma?.raw
      ]
      let raw = RawSyntax.makeLayout(
        kind: SyntaxKind.handleClause,
        from: layout,
        arena: arena,
        leadingTrivia: leadingTrivia,
        trailingTrivia: trailingTrivia
  ...
  public var unexpectedBeforeHandler: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 0)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 0, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(HandleClauseSyntax.self)
    }
  }

  /// The handler expression.
  public var handler: ExprSyntax {
    get {
      return Syntax(self).child(at: 1)!.cast(ExprSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 1, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(HandleClauseSyntax.self)
    }
  }

  public var unexpectedBetweenHandlerAndAsKeyword: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 2)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 2, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(HandleClauseSyntax.self)
    }
  }
  ...
  public var asKeyword: TokenSyntax {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 3, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(HandleClauseSyntax.self)
    }
  }

  public var unexpectedBetweenAsKeywordAndEffectType: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 4)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 4, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(HandleClauseSyntax.self)
    }
  }

  /// The effect protocol type.
  public var effectType: TypeSyntax {
    get {
      return Syntax(self).child(at: 5)!.cast(TypeSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 5, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(HandleClauseSyntax.self)
    }
  }

  public var unexpectedBetweenEffectTypeAndTrailingComma: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 6)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 6, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(HandleClauseSyntax.self)
    }
  }

  /// A trailing comma if there are more handle clauses.
  ///
  /// ### Tokens
  /// 
  /// For syntax trees generated by the parser, this is guaranteed to be `,`.
  public var trailingComma: TokenSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 7, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(HandleClauseSyntax.self)
    }
  }
  ...
  public var unexpectedAfterTrailingComma: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 8, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(HandleClauseSyntax.self)
    }
  }

  public static let structure: SyntaxNodeStructure = .layout([
    \Self.unexpectedBeforeHandler,
    \Self.handler,
    \Self.unexpectedBetweenHandlerAndAsKeyword,
    \Self.asKeyword,
    \Self.unexpectedBetweenAsKeywordAndEffectType,
    \Self.effectType,
    \Self.unexpectedBetweenEffectTypeAndTrailingComma,
    \Self.trailingComma,
    \Self.unexpectedAfterTrailingComma
  ])
}
...
public struct ImportDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  ///   - modifiers: Modifiers that are attached to the import declaration.
