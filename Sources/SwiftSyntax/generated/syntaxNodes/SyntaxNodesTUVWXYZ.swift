...
public struct TypeEffectSpecifiersSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public var throwsClause: ThrowsClauseSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 5, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(TypeEffectSpecifiersSyntax.self)
    }
  }
  ...
  public var unexpectedAfterThrowsClause: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 6, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(TypeEffectSpecifiersSyntax.self)
    }
  }
...
/// ### Children
/// 
///  - `withEffectKeyword`: `<identifier>`
///  - `body`: ``ExprSyntax``
public struct WithEffectExprSyntax: ExprSyntaxProtocol, SyntaxHashable, _LeafExprSyntaxNodeProtocol {
  public let _syntaxNode: Syntax

  public init?(_ node: __shared some SyntaxProtocol) {
    guard node.raw.kind == .withEffectExpr else {
      return nil
    }
    self._syntaxNode = node._syntaxNode
  }
  ...
  /// - Parameters:
  ///   - leadingTrivia: Trivia to be prepended to the leading trivia of the node’s first token. If the node is empty, there is no token to attach the trivia to and the parameter is ignored.
  ///   - body: The closure expression providing the effect handler.
  ///   - trailingTrivia: Trivia to be appended to the trailing trivia of the node’s last token. If the node is empty, there is no token to attach the trivia to and the parameter is ignored.
  public init(
    leadingTrivia: Trivia? = nil,
    _ unexpectedBeforeWithEffectKeyword: UnexpectedNodesSyntax? = nil,
    withEffectKeyword: TokenSyntax,
    _ unexpectedBetweenWithEffectKeywordAndBody: UnexpectedNodesSyntax? = nil,
    ...
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((RawSyntaxArena(), (
      unexpectedBeforeWithEffectKeyword,
      withEffectKeyword,
      unexpectedBetweenWithEffectKeywordAndBody,
      body,
      unexpectedAfterBody
    ))) { (arena, _) in
      let layout: [RawSyntax?] = [
        unexpectedBeforeWithEffectKeyword?.raw,
        withEffectKeyword.raw,
        unexpectedBetweenWithEffectKeywordAndBody?.raw,
        body.raw,
        unexpectedAfterBody?.raw
      ]
      let raw = RawSyntax.makeLayout(
        kind: SyntaxKind.withEffectExpr,
        from: layout,
        arena: arena,
        leadingTrivia: leadingTrivia,
        trailingTrivia: trailingTrivia
  ...
  public var unexpectedBeforeWithEffectKeyword: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 0)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 0, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(WithEffectExprSyntax.self)
    }
  }
  ...
  /// 
  /// For syntax trees generated by the parser, this is guaranteed to be `<identifier>`.
  public var withEffectKeyword: TokenSyntax {
    get {
      return Syntax(self).child(at: 1)!.cast(TokenSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 1, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(WithEffectExprSyntax.self)
    }
  }

  public var unexpectedBetweenWithEffectKeywordAndBody: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 2)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 2, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(WithEffectExprSyntax.self)
    }
  }

  /// The closure expression providing the effect handler.
  public var body: ExprSyntax {
    get {
      return Syntax(self).child(at: 3)!.cast(ExprSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 3, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(WithEffectExprSyntax.self)
    }
  }
  ...
  public var unexpectedAfterBody: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 4, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(WithEffectExprSyntax.self)
    }
  }

  public static let structure: SyntaxNodeStructure = .layout([
    \Self.unexpectedBeforeWithEffectKeyword,
    \Self.withEffectKeyword,
    \Self.unexpectedBetweenWithEffectKeywordAndBody,
    \Self.body,
    \Self.unexpectedAfterBody
  ])
}
